...
assert.match(getDataverseBrowserSnippet(), /buildLivePmoControlCenterFromD365/);
assert.match(getDataverseBrowserSnippet(), /resolveStatusUpdateEntityFromD365/);
assert.match(getDataverseBrowserSnippet(), /retrieveMonthlyPmSelfServiceFlowFromD365/);
assert.match(getDataverseBrowserSnippet(), /simulateStatusWritebackFromD365/);
assert.match(getDataverseBrowserSnippet(), /resolveSubmittedToCandidatesFromD365/);
assert.match(getDataverseBrowserSnippet(), /retrieveStatusHistoryTimelineFromD365/);
assert.match(getDataverseBrowserSnippet(), /checkDuplicateStatusUpdateFromD365/);
assert.match(getDataverseBrowserSnippet(), /retrieveExecutiveSteeringPackFromD365/);
assert.match(getDataverseBrowserSnippet(), /retrievePmoDataGapWorklistFromD365/);
assert.match(getDataverseBrowserSnippet(), /routeCioCfoRiskFromD365/);
assert.match(getDataverseBrowserSnippet(), /retrievePowerBiReadyPortfolioFromD365/);
assert.match(getDataverseBrowserSnippet(), /probeD365PermissionsDetailed/);
assert.match(getDataverseBrowserSnippet(), /buildAuditEvidencePackFromD365/);
assert.match(getDataverseBrowserSnippet(), /pilotStatusWritebackFromD365/);
